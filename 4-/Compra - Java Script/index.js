...
let valorDesconto = (valorCompra*0.1); //Essa variável armazena o valor do desconto.
let valorTotal = (valorCompra - valorDesconto); //Essa variável armazena o valor total da compra.
